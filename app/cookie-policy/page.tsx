      ...
      <section className="hero">
        <div className="container">
          <div className="hero-content text-center max-w-3xl mx-auto">
            <h1>Cookie Policy</h1>
            <p className="text-xl text-gray-600">Learn how we use cookies and similar technologies on our website.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="legal-container">
            ...
            <div className="legal-section">
              ...
              <p>
                Cookies set by the website owner (in this case, Nofonex) are called "first-party cookies". Cookies set
            ...
            <div className="legal-section">
              ...
              <ul>
                <li>
                  ...
                  these cookies are strictly necessary to deliver the Website, you cannot refuse them without impacting
                  how our Website functions.
                </li>
                <li>
                ...
                <li>
                  ...
                  that you find interesting on our Website through third-party social networking and other websites.
              ...
              <table className="w-full border-collapse border border-gray-300 mt-4">
                <thead>
                  <tr className="bg-primary/10">
                    <th className="border border-gray-300 p-2 text-left">Type of Cookie</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Targeting Cookies</td>
                    <td className="border border-gray-300 p-2">
