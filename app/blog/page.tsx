...
const blogPosts: BlogPost[] = [
  {
    id: "machine-translations-that-promise-a-lot",
    title: "Machine Translations That Promise a Lot",
    excerpt:
    ...
    category: "MTPE & Language Quality",
    tags: ["MTPE", "Translation", "English-Dutch", "AI"],
    image: "/images/mtpe-robot-desk.jpg",
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image
                ...
                alt="Machine translations that promise a lot — a robot at a desk"
                fill
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                ...
                <div className="flex items-center">
                  ...
                  <span>MTPE, Translation, English-Dutch</span>
                </div>
              </div>
              <p className="text-gray-600 text-lg">
                The promise of MTPE is appealing: faster turnaround, lower costs, same quality. But after years
                of English-Dutch post-editing, the reality tells a different story. From vanishing human voice
                to the limits of AI transcreation.
              </p>
              <Link
                href="/blog/machine-translations-that-promise-a-lot"
